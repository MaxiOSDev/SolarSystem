...
//  SolarSystem
//
//  Created by Max Ramirez on 4/27/18.
...
// So I subclassed UIView, for an async UIImageView. With the decodedImage, it gets placed back on the main queue, and scrolling is faster now.
